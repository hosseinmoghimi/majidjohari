...
print(atom1)
print(atom2)
print(f'            distanse atom1 to atom2: {atom1.distance(atom2)}')
print(f'    auto_correlation atom1 by atom2: {atom1.auto_correlation(atom2)}')

# output
        # id= 1 ,location = (0,0,0) , spins = (3,4,1)
        # id= 2 ,location = (12,4,3) , spins = (1,2,3)
        #             distanse atom1 to atom2: 13.0
        #     auto_correlation atom1 by atom2: 14
